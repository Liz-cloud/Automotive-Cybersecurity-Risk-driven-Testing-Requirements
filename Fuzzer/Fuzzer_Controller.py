...
# Ensure GPIO pins are released and reset
...
try:
    ...
    logging.info(f'Failed to set pins')
    exit(1)
...
def random_fuzzing():
    print("Starting Random Fuzzing Attack...")
...
def linear_fuzzing():
    print("Starting Linear Fuzzing Attack...")
...
def bruteforce_fuzzing():
    print("Starting Brute Force Fuzzing Attack...")
...
def mutation_fuzzing():
    print("Starting Mutation-Based Fuzzing Attack...")
